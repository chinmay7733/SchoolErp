      ...
      >
        ...
        <div className="px-4 py-4">
          <div className="flex items-center border rounded-md px-3 py-2 text-sm font-medium">
            <img src={school} alt="school" className="h-6 w-6 mr-2" />
        ...
        <nav className="flex-1 overflow-y-auto px-2 space-y-1">
          ...
          >
            ...
            <MdKeyboardArrowDown
              className={`${openDashboard ? "rotate-180" : ""}`}
            />
          </button>

          {openDashboard && (
            <div className="ml-4 space-y-1">
              <NavLink to="/dashboard/admin" className={navItem}>
                Admin Dashboard
              </NavLink>
              <NavLink to="/dashboard/teacher" className={navItem}>
                Teacher Dashboard
              </NavLink>
              <NavLink to="/dashboard/student" className={navItem}>
                Student Dashboard
              </NavLink>
              <NavLink to="/dashboard/parent" className={navItem}>
                Parent Dashboard
              </NavLink>
            </div>
          )}
          ...
          >
            ...
            <MdKeyboardArrowDown
              className={`${openApps ? "rotate-180" : ""}`}
            />
          </button>

          {openApps && (
            <div className="ml-6 space-y-1">
              <NavLink to="/applications/chat" className={subItem}>
                <MdChat /> Chat
              </NavLink>
              <NavLink to="/applications/call" className={subItem}>
                <MdCall /> Call
              </NavLink>
              <NavLink to="/applications/calendar" className={subItem}>
                <MdCalendarMonth /> Calendar
              </NavLink>
              <NavLink to="/applications/email" className={subItem}>
                <MdEmail /> Email
              </NavLink>
              <NavLink to="/applications/todo" className={subItem}>
                <MdTask /> To Do
              </NavLink>
              <NavLink to="/applications/notes" className={subItem}>
                <MdNote /> Notes
              </NavLink>
              <NavLink to="/applications/files" className={subItem}>
                <MdFolder /> File Manager
              </NavLink>
            </div>
          )}
          ...
          >
            ...
            <MdKeyboardArrowDown
              className={`${openLayout ? "rotate-180" : ""}`}
            />
          </button>
          ...
          {openLayout && (
            <div className="ml-6 space-y-1">
              ...
              <div className={subItem}>
                <MdFormatTextdirectionRToL /> RTL
              </div>
              <div className={subItem}>
                <MdCheckBoxOutlineBlank /> Box
              </div>
            </div>
          )}
          <button
          ...
          >
            ...
            <MdKeyboardArrowDown
              className={`${openPeople ? "rotate-180" : ""}`}
            />
          </button>
          ...
          {openPeople && (
            <div className="ml-4 space-y-1">
              ...
              {openStudents && (
                <div className="ml-6 space-y-1">
                  <NavLink to="/people/students" className={subItem}>
                    All Students
                  </NavLink>
                  <NavLink to="/people/promotion" className={subItem}>
                    Student Promotion
                  </NavLink>
                </div>
              )}

              <NavLink to="/people/parents" className={navItem}>
                <MdPerson /> Parents
              </NavLink>
              <NavLink to="/people/guardians" className={subItem}>
                <MdGroups /> Guardians
              </NavLink>
              ...
              {openTeachers && (
                <div className="ml-6 space-y-1">
                  <NavLink to="/people/teachers" className={subItem}>
                    All Teachers
                  </NavLink>
                  <NavLink to="/people/routine" className={subItem}>
                    Routine
                  </NavLink>
                </div>
              )}
          ...
          >
            ...
            <MdKeyboardArrowDown
              className={`${openAcademic ? "rotate-180" : ""}`}
            />
          </button>
          ...
          {openAcademic && (
            <div className="ml-4 space-y-1">
              ...
              {openClasses && (
                <div className="ml-6 space-y-1">
                  <NavLink to="/academic/classes" className={subItem}>
                    All Classes
                  </NavLink>
                  <NavLink to="/academic/schedule" className={subItem}>
                    Schedule
                  </NavLink>
                </div>
              )}

              <NavLink to="/academic/class-room" className={subItem}>
                <MdMeetingRoom /> Class Room
              </NavLink>
              <NavLink to="/academic/class-routine" className={subItem}>
                <MdRepeat /> Class Routine
              </NavLink>
              <NavLink to="/academic/section" className={subItem}>
                <MdViewModule /> Section
              </NavLink>
              <NavLink to="/academic/subject" className={subItem}>
                <MdMenuBook /> Subject
              </NavLink>
              <NavLink to="/academic/syllabus" className={subItem}>
                <MdBook /> Syllabus
              </NavLink>
              <NavLink to="/academic/time-table" className={subItem}>
                <MdAccessTime /> Time Table
              </NavLink>
              <NavLink to="/academic/home-work" className={subItem}>
                <MdHomeWork /> Home Work
              </NavLink>
              ...
              {openExams && (
                <div className="ml-6 space-y-1">
                  <NavLink to="/academic/exam" className={subItem}>
                    <MdAssignment /> Exam
                  </NavLink>
                  <NavLink to="/academic/exam-schedule" className={subItem}>
                    <MdEventNote /> Exam Schedule
                  </NavLink>
                  <NavLink to="/academic/grade" className={subItem}>
                    <MdGrade /> Grade
                  </NavLink>
                  <NavLink to="/academic/exam-attendance" className={subItem}>
                    <MdFactCheck /> Exam Attendance
                  </NavLink>
                  <NavLink to="/academic/exam-results" className={subItem}>
                    <MdRule /> Exam Results
                  </NavLink>
                </div>
              )}

              <NavLink to="/academic/reasons" className={subItem}>
                <MdRule /> Reasons
              </NavLink>
            </div>
          )}
          ...
          >
            ...
            <MdKeyboardArrowDown
              className={`${openManagement ? "rotate-180" : ""}`}
            />
          </button>
          ...
          {openManagement && (
            <div className="ml-4 space-y-1">
              <button
                ...
                className={subItem}
              >
                <MdPayments /> Fees Collection{" "}
                <MdKeyboardArrowDown className="ml-auto" />
              </button>

              {openFees && (
                <div className="ml-6 space-y-1">
                  <NavLink to="/management/fees-group" className={subItem}>
                    Fees Group
                  </NavLink>
                  <NavLink to="/management/fees-type" className={subItem}>
                    Fees Type
                  </NavLink>
                  <NavLink to="/management/fees-master" className={subItem}>
                    Fees Master
                  </NavLink>
                  <NavLink to="/management/fees-assign" className={subItem}>
                    Fees Assign
                  </NavLink>
                  <NavLink to="/management/collect-fees" className={subItem}>
                    Collect Fees
                  </NavLink>
                </div>
              )}
              ...
              {openLibrary && (
                <div className="ml-6 space-y-1">
                  <NavLink to="/management/library-members" className={subItem}>
                    Library Members
                  </NavLink>
                  <NavLink to="/management/books" className={subItem}>
                    Books
                  </NavLink>
                  <NavLink to="/management/issue-book" className={subItem}>
                    Issue Book
                  </NavLink>
                  <NavLink to="/management/return-book" className={subItem}>
                    Return
                  </NavLink>
                </div>
              )}
              ...
              {openHostel && (
                <div className="ml-6 space-y-1">
                  <NavLink to="/management/hostel-list" className={subItem}>
                    Hostel List
                  </NavLink>
                  <NavLink to="/management/hostel-rooms" className={subItem}>
                    Hostel Rooms
                  </NavLink>
                  <NavLink to="/management/room-type" className={subItem}>
                    Room Type
                  </NavLink>
                </div>
              )}
              <button
                ...
                className={subItem}
              >
                <MdDirectionsBus /> Transport{" "}
                <MdKeyboardArrowDown className="ml-auto" />
              </button>

              {openTransport && (
                <div className="ml-6 space-y-1">
                  <NavLink to="/management/routes" className={subItem}>
                    Routes
                  </NavLink>
                  <NavLink to="/management/pickup-points" className={subItem}>
                    Pickup Points
                  </NavLink>
                  <NavLink to="/management/drivers" className={subItem}>
                    Vehicle Drivers
                  </NavLink>
                  <NavLink to="/management/vehicles" className={subItem}>
                    Vehicles
                  </NavLink>
                  <NavLink to="/management/assign-vehicle" className={subItem}>
                    Assign Vehicle
                  </NavLink>
                </div>
              )}
          ...
          {openHRM && (
            <div className="ml-4 space-y-1">
              <NavLink to="/hrm/staffs" className={subItem}>
                <MdBadge /> Staffs
              </NavLink>
              <NavLink to="/hrm/departments" className={subItem}>
                <MdApartment /> Departments
              </NavLink>
              <NavLink to="/hrm/designation" className={subItem}>
                <MdAssignmentInd /> Designation
              </NavLink>
              ...
              {openAttendance && (
                <div className="ml-6 space-y-1">
                  <NavLink to="/hrm/attendance/student" className={subItem}>
                    Student Attendance
                  </NavLink>
                  <NavLink to="/hrm/attendance/teacher" className={subItem}>
                    Teacher Attendance
                  </NavLink>
                  <NavLink to="/hrm/attendance/staff" className={subItem}>
                    Staff Attendance
                  </NavLink>
                </div>
              )}
              ...
              {openLeaves && (
                <div className="ml-6 space-y-1">
                  <NavLink to="/hrm/leaves/list" className={subItem}>
                    List of Leaves
                  </NavLink>
                  <NavLink to="/hrm/leaves/approve" className={subItem}>
                    Approve Request
                  </NavLink>
                </div>
              )}

              <NavLink to="/hrm/holidays" className={subItem}>
                <MdBeachAccess /> Holidays
              </NavLink>
              <NavLink to="/hrm/payroll" className={subItem}>
          ...
          {openContent && (
            <div className="ml-4 space-y-1">
              ...
              {openBlog && (
                <div className="ml-6 space-y-1">
                  <NavLink to="/content/blogs" className={subItem}>
                    All Blogs
                  </NavLink>
                  <NavLink to="/content/categories" className={subItem}>
                    Categories
                  </NavLink>
                  <NavLink to="/content/comments" className={subItem}>
                    Comments
                  </NavLink>
                  <NavLink to="/content/tags" className={subItem}>
                    Tags
                  </NavLink>
                </div>
              )}
          ...
          {openSettings && (
            <div className="ml-4 space-y-1">
              ...
              {openGeneralSettings && (
                <div className="ml-6 space-y-1">
                  <NavLink to="/settings/profile" className={subItem}>
                    Profile Settings
                  </NavLink>
                  <NavLink to="/settings/security" className={subItem}>
                    Security Settings
                  </NavLink>
                  <NavLink to="/settings/notifications" className={subItem}>
                    Notifications
                  </NavLink>
                  <NavLink to="/settings/devices" className={subItem}>
                    Connected Apps
                  </NavLink>
                </div>
              )}
              ...
              {openWebsiteSettings && (
                <div className="ml-6 space-y-1">
                  <NavLink to="/settings/company" className={subItem}>
                    Company Settings
                  </NavLink>
                  <NavLink to="/settings/localization" className={subItem}>
                    Localization
                  </NavLink>
                  <NavLink to="/settings/prefixes" className={subItem}>
                    Prefixes
                  </NavLink>
                  <NavLink to="/settings/preferences" className={subItem}>
                    Preferences
                  </NavLink>
                  <NavLink to="/settings/social-auth" className={subItem}>
                    Social Authentication
                  </NavLink>
                  <NavLink to="/settings/language" className={subItem}>
                    Language
                  </NavLink>
                </div>
              )}
              ...
              {openAppSettings && (
                <div className="ml-6 space-y-1">
                  <NavLink to="/settings/invoice" className={subItem}>
                    Invoice Settings
                  </NavLink>
                  <NavLink to="/settings/custom-fields" className={subItem}>
                    Custom Fields
                  </NavLink>
                </div>
              )}
              ...
              {openSystemSettings && (
                <div className="ml-6 space-y-1">
                  <NavLink to="/settings/email" className={subItem}>
                    Email Settings
                  </NavLink>
                  <NavLink to="/settings/email-templates" className={subItem}>
                    Email Templates
                  </NavLink>
                  <NavLink to="/settings/sms" className={subItem}>
                    SMS Settings
                  </NavLink>
                  <NavLink to="/settings/otp" className={subItem}>
                    OTP
                  </NavLink>
                  <NavLink to="/settings/gdpr" className={subItem}>
                    GDPR Cookies
                  </NavLink>
                </div>
              )}
              ...
              {openFinancialSettings && (
                <div className="ml-6 space-y-1">
                  <NavLink to="/settings/payment-gateway" className={subItem}>
                    Payment Gateway
                  </NavLink>
                  <NavLink to="/settings/tax-rates" className={subItem}>
                    Tax Rates
                  </NavLink>
                </div>
              )}
              ...
              {openAcademicSettings && (
                <div className="ml-6 space-y-1">
                  <NavLink to="/settings/school" className={subItem}>
                    School Settings
                  </NavLink>
                  <NavLink to="/settings/religion" className={subItem}>
                    Religion
                  </NavLink>
                </div>
              )}
              ...
              {openOtherSettings && (
                <div className="ml-6 space-y-1">
                  <NavLink to="/settings/storage" className={subItem}>
                    Storage
                  </NavLink>
                  <NavLink to="/settings/ip-ban" className={subItem}>
                    Ban IP Address
                  </NavLink>
                </div>
              )}
          ...
          >
            ...
            <MdKeyboardArrowDown
              className={`${openMultiLevel ? "rotate-180" : ""}`}
            />
          </button>
          ...
          {openMultiLevel && (
            <div className="ml-4 space-y-1">
              ...
              {openMultiLevel2 && (
                <div className="ml-6 space-y-1">
                  <NavLink to="/multilevel/2-1" className={subItem}>
                    Multilevel 2.1
                  </NavLink>
                  <NavLink to="/multilevel/2-2" className={subItem}>
                    Multilevel 2.2
                  </NavLink>
                  <NavLink to="/multilevel/2-2-1" className={subItem}>
                    Multilevel 2.2.1
                  </NavLink>
                  <NavLink to="/multilevel/2-2-2" className={subItem}>
                    Multilevel 2.2.2
                  </NavLink>
                </div>
              )}
